...
var slideArray = [];
var listImage = ["../image/slide1.jpg",
  "../image/slide2.jpg",
  "../image/slide3.jpg",
  "../image/slide4.jpg"
]
...
function buildSlider() {
  ...
  for (var i = 0; i < slideArray.length; i++) {
    myHTML +=
      "<div id='" +
      slideArray[i].id +
      "' class='singleSlide' style='background-size: cover;background-position: center;background-repeat: no-repeat;background-image:url(" +
