...
for (let i in listImage) {
  new Slide(
    `<svg width="350" height="100" xmlns="http://www.w3.org/2000/svg">
      <text x="0" y="60" font-family="Pacifico, cursive" font-size="60" fill="white">Tiến Chương</text>
    </svg> 
    ...
    <svg width="350" height="100" xmlns="http://www.w3.org/2000/svg">
      <text x="0" y="60" font-family="Pacifico, cursive" font-size="60" fill="white">Thục Đoan</text>
    </svg> `,
    "24/10/2023",
    listImage[i]
  )
